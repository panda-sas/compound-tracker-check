...
def create_dispatcher_endpoint(dispatcher_data: dict, db: Session = Depends(get_db)):
...
def update_dispatcher_endpoint(dispatcher_id: int, dispatcher_data: dict, db: Session = Depends(get_db)):
...
# Projects Endpoints
@app.post("/projects/")
def create_project_endpoint(project_data: dict, db: Session = Depends(get_db)):
...
def update_project_endpoint(project_id: int, project_data: dict, db: Session = Depends(get_db)):
...
# Targets Endpoints
@app.post("/targets/")
def create_target_endpoint(target_data: dict, db: Session = Depends(get_db)):
...
def update_target_endpoint(target_id: int, target_data: dict, db: Session = Depends(get_db)):
...
def create_checkinout_endpoint(checkinout_data: dict, db: Session = Depends(get_db)):
...
def update_checkinout_endpoint(checkinout_id: int, checkinout_data: dict, db: Session = Depends(get_db)):
